...
//            request1.setStatusId(3);
//            request1.setDeclinationReason("We don't have needed instruments.");
//            requestCon.updateRequestById(request1.getRequestId(), request1);
//
...
//            System.out.println("\nDelete request by id");
//            requestCon.deleteById(request1.getRequestId());
//
//            // View all requests
//            System.out.println("\nView all requests");
...
//            System.out.println("\nDelete feedback by id");
//            feedbackCon.deleteById(feedbacksList1.get(1).getFeedbackId());
//
//            // View all feedbacks
//            System.out.println("\nView all feedbacks by request id");
